<template>
    <div class="changePwdwrap">
        ...
        <div class="login-con">
            ...
            <input type="button" class="regBtn" @click="register" value="注册">

            <router-link class="tologin" to="/mine">已有账号！立即登录</router-link>
...
<script>
    //curl -X POST -d "jhdgsj=asdfjlk" "http://localhost:8889/mine/register"   终端post请求
        ...
        methods: {
            ...
            register() {
                if (!(/^1[3|4|5|8][0-9]\d{4,8}$/.test(this.tel))) {//手机格式判断
                    ...
                    this.$http.post("/api/mine/register",params)
